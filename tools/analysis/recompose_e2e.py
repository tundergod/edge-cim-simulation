...
Writes measurements/metis_card/twopillar_prediction_fitted.json, validation/reports/recompose.json
...
def main():
    ...
    (ROOT / "validation/reports/recompose.json").write_text(json.dumps(out, indent=1))
