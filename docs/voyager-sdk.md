...
**CIM-Card revalidation (production card, v1.6)** `[MEASURED 2026-06-06]` (`characterization/metis_card/run_metis_cim_v16.py` → `validation/reports/phase1.2/cim_card_revalidate.json`):
