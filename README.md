...
Bootstrap 階段。文獻語料、SDK 參考、專案綱要已就位。下一步：Phase 0 真實板特性量測（見 [overall.md](overall.md) § Phase 0）→ 接著 M1–M7 模擬器建構。`overall.md` 所述的 `simulator/`、`measurements/`、`characterization/`、`validation/`、`tools/`、`docs/` 目錄為規劃版面，待工作開始時建立。
