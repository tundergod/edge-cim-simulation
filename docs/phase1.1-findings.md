# Phase 1.1 — component modeling & validation findings

Phase 1.1 turns the committed Phase 0.2/0.3 measurements into **closed-form latency
...
> **Calibration-scope declaration (important): Phase 1.1 is a *decode-calibrated* model.**
